...
import com.sparta.deliverit.review.presentation.dto.response.OrderReviewResponse;
...
public class OrderReviewControllerV1 {
    ...
    public ResponseEntity<OrderReviewResponse> getOrderReviews(
            @PathVariable String orderId
    ) {
        return ResponseEntity.ok(new OrderReviewResponse(
                List.of(
                        new ReviewResponse(
                                1L,
                                "userId",
